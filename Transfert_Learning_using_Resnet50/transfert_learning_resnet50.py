...
# if you make require_flatten=False , you will remve the 2 laster layer
# (flastten and dense)
...
#--------------------Compile and trin the custom resnet model1--------------------#
custom_resnet_model2.compile(
    loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
# train
t = time.time()
hist = custom_resnet_model2.fit(
    X_train, y_train, batch_size=32, epochs=10, verbose=1, validation_data=(X_test, y_test))
print('Training time: %s' % (t - time.time()))
# evaluated the trained model adn get the scores
(loss, accuracy) = custom_resnet_model2.evaluate(
